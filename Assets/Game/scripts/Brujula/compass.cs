...
public class compass : MonoBehaviour
{
    ...
    void FindClosestMision()
    {
        ...
        {
            GameObject FinDeJuego = GameObject.FindGameObjectWithTag("FinDeJuego");
            float distance = Vector3.Distance(Player.position, FinDeJuego.transform.position);

            closestDistance = distance;
            targetMision = FinDeJuego.transform;
        }
    }
